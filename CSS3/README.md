...
- [3、清除浮动有哪些方式？](#清除浮动有哪些方式)
- [4、CSS 中隐藏元素的方法有哪些？](#css-中隐藏元素的方法有哪些)
- [5、CSS 选择器有哪些、优先级如何？](#css-选择器有哪些-优先级如何)
- [6、单行元素的文本省略，多行元素的文本省略](#单行元素的文本省略多行元素的文本省略)
- [7、CSS 样式表根据所在网页的位置，可分为哪几种样式表？](#css-样式表根据所在网页的位置可分为哪几种样式表)
- [8、如何实现一个元素的水平垂直居中？](#如何实现一个元素的水平垂直居中)
- [9、flex：1 的含义？](#flex1-的含义)
- [10、CSS3 动画的优点/缺点是什么？](#css3-动画的优点缺点是什么)
...
#### 什么是块级元素的外边距折叠？为什么会出现垂直块级元素的外边距折叠？如何解决这个问题？
