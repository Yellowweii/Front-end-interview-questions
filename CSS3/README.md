...
- [2、说一下 css 盒模型](#说一下-css-盒模型)
- [3、CSS 中隐藏元素的方法有哪些？](#css-中隐藏元素的方法有哪些)
- [4、CSS 选择器有哪些、优先级如何？](#css-选择器有哪些-优先级如何)
- [5、单行元素的文本省略，多行元素的文本省略](#单行元素的文本省略多行元素的文本省略)
- [6、CSS 样式表根据所在网页的位置，可分为哪几种样式表？](#css-样式表根据所在网页的位置可分为哪几种样式表)
- [7、如何实现一个元素的水平垂直居中？](#如何实现一个元素的水平垂直居中)
- [8、flex：1 的含义？](#flex1-的含义)
- [9、CSS3 动画的优点/缺点是什么？](#css3-动画的优点缺点是什么)
...
box-sizing 属性：content-box(算元素的总宽度和高度时，不包含内外边距和边框，只有内容区的大小)，border-box(内边距和边框不影响盒子宽度和高度)
